...
const sampleReactCodeFromLegacy = `import React, { useState, useEffect } from "react";
    ...
    if (apiProvider === 'Demo') {
      setTimeout(() => {
        ...
        if (targetStack.toLowerCase() === 'english') {
          ...
          // Check for recognizable legacy Ember UserPosts code structure
          ...
          if (isUserPostsComponent) {
            // Provide a real React functional translation demo:
            demoResult = sampleReactCodeFromLegacy;
          } else {
            // For other arbitrary code, show fallback snippet (or improve as needed)
